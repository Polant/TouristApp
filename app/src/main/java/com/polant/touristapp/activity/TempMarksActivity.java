...
import com.polant.touristapp.fragment.TempMarksRecyclerFragment;
import com.polant.touristapp.interfaces.IWorkWithDatabaseActivity;

public class TempMarksActivity extends AppCompatActivity implements IWorkWithDatabaseActivity{

    private static final int LAYOUT = R.layout.activity_marks_recycler;
    private static final String MARKS_FRAGMENT_TAG = TempMarksRecyclerFragment.class.toString();
    ...
    private void initMarksFragment() {
        ...
        TempMarksRecyclerFragment fragment = new TempMarksRecyclerFragment();
